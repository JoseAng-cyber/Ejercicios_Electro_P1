...
\textbf{\theejercicio.} Una carga de $-0.3\mu C$ se encuentra en el punto 
...
Expresnado en mentros los puntos:
...
\stepcounter{ejercicio}
\textbf{\theejercicio.}Dado un material no magnetico que tenga un $\epsilon_r^,
...
\stepcounter{ejercicio}
\textbf{\theejercicio.}Considere un material para que $\mu_r=1$, $\epsilon_r=2.5$ y la tangente de perdidas es de 0.12. Si esos 
