...
\noindent a) Expresnado en mentros los puntos:
...
\noindent b) Repetimos el proceso para el punto P(15,20,50)cm.
...
\noindent a) \[\tan \delta =\frac{\sigma}{\omega \epsilon^,}=\frac{1.5 \times 10^{-4}}{(2\pi \cdot 3 \times 10^6)(3.2)(8.854 \times 10^{-12})}=0.28\]

\vspace{0.5cm}

\noindent b) \[\alpha = Re{jk}=\omega \sqrt{\frac{\mu_0 \epsilon _r}{2}} \left( \sqrt{1+\left( \frac{\sigma}{\omega \epsilon_r^,} \right)^2}-1 \right)^\frac{1}{2}\]
\[\alpha= \]

\vspace{0.5cm}

\noindent c) \[\beta=\omega \sqrt{\mu_0\epsilon_0\epsilon_r^,}=6\pi \times 10^6\sqrt{(4\pi \times 10^{-7})(8.854 \times ^{-12})(3.2)}=0.11\]

\vspace{0.5cm}

\noindent d)\[\eta = \sqrt{\frac{\mu}{\epsilon^,-j\epsilon^{,,}}} \quad \rightarrow \quad \sqrt{\frac{\mu}{\epsilon_0}}\frac{1}{\sqrt{\epsilon_r^,}}\frac{1}{\sqrt{1-j\frac{\epsilon_r^{,,}}{\epsilon_r^,}}} \quad \rightarrow \quad \sqrt{\frac{\mu}{\epsilon_0\epsilon_r^,}}\frac{1}{\sqrt{1-j\frac{\sigma}{\omega \epsilon_r^,}}}\]
...
\noindent a) \[ \tan \delta =\frac{\sigma}{\omega \epsilon^,} \quad \rightarrow \quad \sigma =\omega \epsilon_r^, \epsilon_0 \tan \delta \]
...
\noindent b) En el area efectiva en ac, ocurre el efecto piel y la profundidad depiel resulta se muy peque;a a comparacion del grosor de 2mm de la tuberia, por lo cual, solo se toma en cuenta el area efectiva de la capa exterior.
...
\noindent c) Para el caso de la resistencia en corriente directa, no ocurre el efecto piel por lo cual se contempla ambos radio. El radio mayor menos el radio menor es igual al la superficie transversal.
...
\noindent d)Para calcular la potencia promedio se hace uso de la definicion:
